...
```{r setup, echo=FALSE}
# Narrower console width so printed output fits PDF code boxes.
options(width = 70)
# Example (unused): force svg figures at half page width
# knitr::opts_chunk$set(
#   fig.width = 1, fig.height = 7, dev = "svg", out.width = "50%")
```
