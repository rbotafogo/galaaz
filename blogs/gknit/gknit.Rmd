...
written both in Ruby or R and output it in any of the available formats of __R markdown__.
...
'included' in the document as if we had typed it in __R markdown__.  
...
The three '###' are the way we add a Heading 3 in __R markdown__.
