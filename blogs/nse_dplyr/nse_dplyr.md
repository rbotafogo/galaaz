...
```
## R Error (Nested): object 'a' not found
## 
## Code: seq=1796 .GlobalEnv$g2_v698 <- { a + b
##  }
## 
## --- R traceback ---
...
```
## R Error (Nested): ℹ In argument: `y <- a + x`.
## 
## Code: seq=6092 .GlobalEnv$g2_v2295 <- mutate(g2_v2207, y <- a + x)
```
