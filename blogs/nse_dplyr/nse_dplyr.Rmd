...
it cal also be, as stated above, a question of years to master it. Programming with _dplyr_
...
Very often R is used interatively and users use _dplyr_ to manipulate a single dataset and
thus no programming with _dplyr_ is needed. When users want to replicate their work for
...
showing the problems it faces and how to solve them.
...
This blog is organized as follows: first we show how to write expressions using Galaaz, then 
we show how Ruby and R can be integrated and how R functions are transparently called from
Ruby. 
...
how those problems are treated in _dplyr_ should read the vignette and use it as comparison with
this blog.
