...
# Default bridge wait is 60s; full manual knits hit that on slow chunks (e.g. data.table::fread
# downloading flights14.csv from GitHub). Raise for this document unless already set.
