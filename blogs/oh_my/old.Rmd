...
subtitle: "Archived variant (Renjin-era narrative); see `oh_my.Rmd` and the Galaaz 2.0 manual for current stack"
author:
    - "Rodrigo Botafogo"
    - "Daniel Mossé - University of Pittsburgh"
tags: [Archived, Tech, Data Science, Ruby, R, Renjin]
...
Below, we use method 'get' which is a synonym of method 'as__mdarray' to again get the content
...
the same object) in which another method can be applied.  In the example below, method '<<'
