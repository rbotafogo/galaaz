# -*- coding: utf-8 -*-
# Phase 1: concurrent bridge spec. N threads × M rounds of eval_r_with_result;
# assert no exceptions, every result correct, and exactly N×M results (no loss/duplicates).

require 'galaaz'

describe "Bridge concurrent access (Phase 1)" do
